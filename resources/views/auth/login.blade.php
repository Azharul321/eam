		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="{{ asset('img/hi.png')}}" style="hight:60px; width:60px;" alt="logo icon">
		 	</div>
          ...
          @csrf
			 ...
			 <div class="form-row mt-4">
			  <div class="form-group mb-0 col-12">
			   <a href="{{route('redirectToGoogle')}}" type="button" class="btn btn-light btn-block"><i class="fa fa-google-square"></i> Google</a>
			 </div>
			</div>
		  ...
		  <div class="card-footer text-center py-3">
		    <p>admin: eam@gmail.com pass: 12345</p>
        <p>employee: azharu321@gmail.com pass:12345</p>
		  </div>
	     </div>
